  ...
  return (
    ...
    >
      <View style={styles.groupHeader}>
        ...
        <Text style={[styles.groupProgressText, { color: color }]}>
          {progress}%
        </Text>
      </View>
...
const HomeScreen = ({ navigation }) => {
  ...
  const getGroupStats = groupName => {
    ...
    const totalProgress = groupTasks.reduce(
        ...
        <View style={styles.progressBlock}>
          <View style={styles.progressBlockInfo}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate(SCREENS.TASKS_LIST, { groupName: null })
              }
            >
      ...
      >
        ...
        {tasks
          ...
          .map(task => {
            const colorsMap = {
              ...
              Kids: COLORS.tertiary,
              Home: COLORS.quaternary,
            };
            return (
              <InProgressCard
                key={task.id}
        ...
        {tasks.filter(t => t.progress < 100).length === 0 && (
          <Text style={styles.noTasksText}>
            No tasks in progress. Enjoy your day! 🎉
          </Text>
        )}
