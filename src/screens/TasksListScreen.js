...
const styles = StyleSheet.create({
  ...
  themeBtn: { padding: 10, borderRadius: 10, alignSelf: 'flex-end', marginBottom: 10 },
  ...
  dateCard: { width: 45, height: 55, justifyContent: 'center', alignItems: 'center', marginRight: 10, borderRadius: 15 },
  ...
  taskRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, width: '100%' },
  taskItemContainer: { flex: 1 },
  deleteButton: { width: 45, marginLeft: 10, padding: 10, backgroundColor: '#FED7D7', borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  deleteIcon: { fontSize: 18 },
  emptyText: { textAlign: 'center', color: '#A0AEC0', marginTop: 50, fontSize: 16 },
});
